  ...
  return (
    <div className="p-8 space-y-8">
      <div className="space-y-2">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-slate-400">Comprehensive open-source intelligence gathering</p>
          </div>
        </div>
      </div>
      ...
      <div className="glass-effect rounded-lg p-12 text-center space-y-4">
        ...
        <p className="text-slate-400 max-w-md mx-auto">Multi-source intelligence framework for comprehensive reconnaissance and data gathering across public sources.</p>
      </div>
    </div>
  )
}
